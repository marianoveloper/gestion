...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100">
       ...
       /* [
        'title' => 'Dashboard',
        'url' => route('sala.dashboard'),
        'active' => request()->routeIs('sala.dashboard'),
        'icon' => 'fa-solid fa-gauge-high',
        ],*/
        [
            'title'=>'Candidato',
            'url'=> route('sala.candidato.index'),
            'active' => request()->routeIs('sala.candidato.index'),
            'icon' => 'fa-solid fa-gauge-high',
        ],
          /* [
            'title'=>'Crear Candidato',
            'url'=> route('sala.candidato.create'),
            'active' => request()->routeIs('sala.candidato.create'),
            'icon' => 'fa-solid fa-gauge-high',
        ],
     [
        ...
        <div class="flex" x-data="{ open: false, openSidebar: true }">
            <div :class="{ 'lg:block': openSidebar, }" class="flex-shrink-0 hidden w-64 lg:block">
                ...
                @include('layouts.partials.sala.sidebar'){{-- aqui incluyo el sidebar que esta en sidebar.blade.php --}}
            </div>

            <div class="w-full ">
                @include('layouts.partials.sala.navigation'){{-- aqui incluyo el menu de navegacion que esta en navigation.blade.php --}}
