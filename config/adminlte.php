...
return [
    ...
    */
    ...
    ['text' => 'Notificación de Matriculación',
    'route' => 'admin.notificacion.index',
    'icon' => 'fas fa-user-edit',
],
    ['text' => 'Desmatriculación',
...
'icon' => 'fas fa-user-edit',
    ...
    'route' => 'admin.informe.index',
    'icon' => 'fas fa-user-edit',
    ],
        ['header' => 'OPCIONES DE EXAMEN FINAL'],

    ['text' => 'Matriculacion de Examen',
    'route' => 'admin.matriculacion-examen.index',
    'icon' => 'fas fa-user-edit',
    ],
    ['text' => 'Aula de Examen',
    'route' => 'admin.examen-aula.index',
    'icon' => 'fas fa-user-edit',
    ],
...
['text' => 'Desmatriculación Propuestas',
'route' => 'admin.desmatriculacion-propuesta.index',
'icon' => 'fas fa-user-edit',
],
