<x-app-layout>
    ...
    <div class="container py-8">
        ...
        <section class="py-8 " style="background-image: url({{asset('images/homes/barra-verde.png')}})">
            <h1 class="text-3xl text-center text-white">Aula Común</h1>
        ...
        <div class="card">
            <div class="card-body">
                ...
                {!! Form::open(['route'=> 'aulacomun.store','files'=>true, 'autocomplete'=>'off']) !!}
                ...
                <h1 class="mt-8 text-2xl font-bold text-center bg-green-200">Modelo Excel Aula Común</h1>
                <hr class="mt-2 mb-6">
                <span>
                ...
                <div class="mt-4 mb-4">
                    <figure>
                        @isset($course->image)
                        <img id="picture" class="object-cover object-center w-full h-58" src="#">
                        @else
                        <img id="picture" class="object-cover object-center w-full h-58"
                            src="{{asset('images/homes/aulacomun2.png')}}">
                        @endisset
                    </figure>
