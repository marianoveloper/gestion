...
<body>
    <section class="flex items-stretch min-h-screen text-white ">
        <div class="relative items-center hidden w-full bg-gray-500 bg-no-repeat bg-cover lg:flex" style="background-image: url({{asset('images/homes/girl.jpg')}});">
            <div class="absolute inset-0 z-0 bg-black opacity-40"></div>
           <!-- <div class="z-10 w-full px-24">
                <h1 class="text-5xl font-bold tracking-wide text-left">Bienvenido al DEV</h1>
                <p class="my-4 text-3xl">Sistema de Gestión Virtual</p>
            </div>-->
        ...
        <div class="z-0 flex items-center justify-center w-full px-0 text-center lg:w-1/2 md:px-16" style="background-color: #034a31;">
            <div class="absolute inset-0 z-10 items-center bg-gray-500 bg-no-repeat bg-cover lg:hidden" style="background-image: url({{asset('images/homes/girl.jpg')}});">
                <div class="absolute inset-0 z-0 bg-black opacity-60"></div>
            </div>

            <div class="z-20 w-full py-6">
                <div class="z-10 w-full px-24">
                    <h1 class="text-4xl font-bold tracking-wide text-center">Bienvenido </h1>
                    <p class="my-3 text-3xl">Sistema de Gestión Virtual</p>
                </div>
                <h1 class="my-6">
                   ...
                   <img  class="inline-flex w-auto h-7 sm:h-8" src={{asset('images/logos/icono4.png')}}>
                </h1>
            ...
            <form method="POST" action="{{ route('login') }}" class="w-full px-4 mx-auto sm:w-2/3 lg:px-0">
                ...
                <!--<form action="" class="w-full px-4 mx-auto sm:w-2/3 lg:px-0">
                    ...
                    <div class="px-4 pt-4 pb-2">
                        <button class="block w-full p-4 text-lg uppercase bg-indigo-500 rounded-full hover:bg-indigo-600 focus:outline-none">sign in</button>
                    </div>
